...
int main(int argc, char **argv) 
{
	...
	/*
	// Just to test: points are listed one after the other in xyzxyzxyz .. 
	cerr << "Points: " << endl;
	...
	cerr << endl;
	// Just to test: faces are 0-indexed one after the other in 012234 .. 
	cerr << "Faces: " << endl;
	for ( std::vector<unsigned>::const_iterator it = faces.begin();
	      it != faces.end(); ++it ) {
	  cerr << *it << " ";
	}
	cerr << endl;
